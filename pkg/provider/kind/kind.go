...
func (c *KIND) ClusterCreate(*kingpin.ParseContext) error {
	...
	fmt.Println(c.DeploymentFiles)
	//provider := cluster.NewProvider(
	//	cluster.ProviderWithLogger(cmd.NewLogger()),
	//)
	//fmt.Println(provider)

	//create := cluster.CreateWithConfigFile(c.DeploymentFiles[0])
	////fmt.Println(create)
...
func (c *KIND) clusterDeleted(req *containerpb.DeleteClusterRequest) (bool, error) {
...
func (c *KIND) clusterRunning(zone, projectID, clusterID string) (bool, error) {
